...
set_property IOSTANDARD LVCMOS18 [get_ports {slave_data_output[7]}]
set_property IOSTANDARD LVCMOS18 [get_ports {slave_data_output[6]}]
set_property IOSTANDARD LVCMOS18 [get_ports {slave_data_output[5]}]
set_property IOSTANDARD LVCMOS18 [get_ports {slave_data_output[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {slave_data_output[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {slave_data_output[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {slave_data_output[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {slave_data_output[0]}]
